...
![Simple cloud-native app with backend database service.](images/cf2ce-get-started.svg){: caption="Simple cloud-native app with backend database service." caption-side="bottom"}
