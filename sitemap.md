...
* [June 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-june26)
    ...
    * [23 June 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-jun2326)

        * CLI version 1.62.6 released

    * [16 June 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-jun1626)
...
* [April 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-april26)
    ...
    * [24 April 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-april2426)
        ...
        * CLI version 1.62.3 released

    * [09 April 2026](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-april0926)

        * CLI version 1.62.2 released
...
* [November 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-november25)
    ...
    * [21 November 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-november2125)

        * CLI version 1.57.0 released

        * Updated versions for buildpacks

    * [13 November 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-november1325)

        * CLI version 1.56.1 released
...
* [September 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-september25)
    ...
    * [05 September 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-september0525)
        ...
        * CLI version 1.54.5 released

    * [04 September 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-september0425)

        * CLI version 1.54.4 released
...
* [May 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-may25)
    ...
    * [15 May 2025](/docs/codeengine?topic=codeengine-codeengine-relnotes#codeengine-may1525)
...
* [Version v1.0](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-changelog-contents-v1_0)
    ...
    * [Worker image `v1.0.323`, released 24 August 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_323)

    * [Worker image `v1.0.311`, released 10 August 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_311)

    * [Worker image `v1.0.304`, released 03 August 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_304)

    * [Worker image `v1.0.298`, released 27 July 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_298)
    ...
    * [Worker image `v1.0.264`, released 22 June 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_264)

    * [Worker image `v1.0.259`, released 15 June 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_259)

    * [Worker image `v1.0.254`, released 08 June 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_254)

    * [Worker image `v1.0.244`, released 01 June 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_244)

    * [Worker image `v1.0.237`, released 25 May 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_237)
    ...
    * [Worker image `v1.0.197`, released 20 April 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_197)

    * [Worker image `v1.0.192`, released 13 April 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_192)

    * [Worker image `v1.0.188`, released 06 April 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_188)

    * [Worker image `v1.0.182`, released 23 March 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_182)

    * [Worker image `v1.0.177`, released 16 March 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_177)

    * [Worker image `v1.0.171`, released 09 March 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_171)

    * [Worker image `v1.0.164`, released 02 March 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_164)

    * [Worker image `v1.0.158`, released 16 February 2026](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_158)
    ...
    * [Worker image `v1.0.42`, released 20 October 2025](/docs/codeengine?topic=codeengine-fleets-worker-changelog-v1_0#fleets-worker-boms-v1_0_42)
...
[Binding a service instance to an application, job, or function workload](/docs/codeengine?topic=codeengine-bind-services#bind-services)
...
* [Binding a service instance to a {{site.data.keyword.codeengineshort}} application, job, or function with the CLI](/docs/codeengine?topic=codeengine-bind-services#bind-cli)
...
[Writing and viewing logs for apps, jobs, and functions](/docs/codeengine?topic=codeengine-logging#logging)

* [Writing logs](/docs/codeengine?topic=codeengine-logging#writing-logs)

    * [Considerations for writing logs](/docs/codeengine?topic=codeengine-logging#writing-logs-considerations)

    * [Log formats](/docs/codeengine?topic=codeengine-logging#writing-logs-format)

    * [Unstructured logs](/docs/codeengine?topic=codeengine-logging#writing-logs-format-unstructured)

    * [Structured logs](/docs/codeengine?topic=codeengine-logging#writing-logs-format-structured)

    * [Logging fields](/docs/codeengine?topic=codeengine-logging#logging-fields)

* [Viewing logs from the console](/docs/codeengine?topic=codeengine-logging#view-logs-ui)

    * [Considerations for viewing logs from the console](/docs/codeengine?topic=codeengine-logging#view-logs-considerations)

    * [Viewing app, job, or function logs from the console](/docs/codeengine?topic=codeengine-logging#view-appjobfunctionlogs-ui)

    * [Viewing build logs from the console](/docs/codeengine?topic=codeengine-logging#view-build-ui)

* [Viewing logs with the CLI](/docs/codeengine?topic=codeengine-logging#view-logs-cli)

    * [Viewing application logs with the CLI](/docs/codeengine?topic=codeengine-logging#view-applog-cli)

    * [Viewing job logs with the CLI](/docs/codeengine?topic=codeengine-logging#view-joblog-cli)

    * [Viewing build logs with the CLI](/docs/codeengine?topic=codeengine-logging#view-build-cli)
...
* [Disaster Recovery for {{site.data.keyword.codeengineshort}} instances](/docs/codeengine?topic=codeengine-ha-dr#ha-dr-disaster)
    ...
    * [How IBM helps ensure disaster recovery](/docs/codeengine?topic=codeengine-ha-dr#ha-dr-ibm-how)

    * [Planning for disaster recovery](/docs/codeengine?topic=codeengine-ha-dr#ha-dr-planning)
