...
| {{site.data.keyword.logs_full_notm}} | - Add log management capabilities to your project by creating an {{site.data.keyword.logs_full_notm}} instance. For more information, see [Viewing logs](/docs/codeengine?topic=codeengine-logging).\n- View, manage, and audit user-initiated activities made in your {{site.data.keyword.codeengineshort}} service instance (project). For more information, see [Auditing events for {{site.data.keyword.codeengineshort}}](/docs/codeengine?topic=codeengine-at_events). |
