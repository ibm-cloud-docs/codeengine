...
if your registry is public, you do not have to set up authorities in order to pull images. 
...
| Push images | Read and write access | When you build source code, you must push the image to a registry. To push images, you need write access. You cannot push images to a different type of registry. |
