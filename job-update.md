...
12. By [viewing job logs from the console](/docs/codeengine?topic=codeengine-codeengine-logging&interface=ui#view-appjobfunctionlogs-ui) for this job, the output of the updated job is `Hello Sunshine!`.
