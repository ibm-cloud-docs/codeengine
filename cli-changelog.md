...
| --------- | -------- | -------- |
| 0.4.2227 | 21 September 2020 | <ul><li>Added `--wait` option to the `app update` command. This option specifies that the `app update` waits for the new revision to be ready before it exits.</li></ul> |
