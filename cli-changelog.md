...
| ----- | ------- | -------------- |
| 0.5.10 | 05 January 2021 | <ul><li>Updated `app get` command to expose all app resources with json output.</li><li>Update to redirect error messages to `stderr` logs.</li><li>Fixed a bug where incorrect app instance data was displaying.</li><li>Fixed bug to continue to wait for the app to start on recoverable errors.</li></ul>|
