...
{{site.data.keyword.codeengineshort}} provides custom resource definition (CRD) methods. For more information, see [{[kn-service] API reference - Source -to-image CRD methods](https://cloud.ibm.com/docs/codeengine?topic=codeengine-api#api-crd-s2i).
...
| .NET Core | 5.0.201 (.NET Core SDK),</br> 5.0.4 (.NET Core Runtime) | [.NET Core samples](https://github.com/paketo-buildpacks/samples/tree/main/dotnet-core){: external}. |
