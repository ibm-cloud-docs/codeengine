...
| 422 | The function code is invalid and cannot be processed. See platform logs for details. |
...
{: caption="HTTP response codes" caption-side="bottom"}
...
{: caption="Status codes" caption-side="bottom"}
...
{: caption="Visibility for functions" caption-side="bottom"}
