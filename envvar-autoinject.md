...
When you deploy an application, a function, or run a job, {{site.data.keyword.codeengineshort}} automatically injects certain environment variables into the application, function, or job.
{: shortdesc}

## Automatically injected environment variables for applicationss
{: #inside-env-vars-app}
