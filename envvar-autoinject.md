...
|--------------------|-------------------------------------------------------|--------------|
| `CE_API_BASE_URL`  | The {{site.data.keyword.codeengineshort}} API URL that is based on the region of the project. Use this URL for API endpoint calls to the endpoint for all components (including applications) that are located in the same region of your {{site.data.keyword.codeengineshort}} project.  | `CE_API_BASE_URL=https://api.us-south.codeengine.cloud.ibm.comp` |
...
| Environment variable | Description | Example |
|----------------|---------------------|---------|
| `CE_API_BASE_URL`  | The {{site.data.keyword.codeengineshort}} API URL that is based on the region of the project. Use this URL for API endpoint calls to the endpoint for all components (including jobs) that are located in the same region of your {{site.data.keyword.codeengineshort}} project.   | `CE_API_BASE_URL=https://api.us-south.codeengine.cloud.ibm.comp` |
