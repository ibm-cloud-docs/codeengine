...
For more information about how {{site.data.keyword.codeengineshort}} works, see [Tuning IBM Cloud Code Engine Scale-Down Delay to Reduce Application Response Times](https://community.ibm.com/community/user/blogs/samuel-matzek1/2023/08/30/tuning-ibm-cloud-code-engine-scale-down-delay){: external}.
...
The default value for the maximum number of instances for your app is `10`. For more information, see [Scaling boundaries](#app-scale-boundaries).
