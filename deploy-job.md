...
{{site.data.keyword.codeengineshort}} provides custom resource definition (CRD) methods. For more information, see [{[kn-service] API reference - Batch CRD methods](https://cloud.ibm.com/docs/codeengine?topic=codeengine-api#api-crd-batch).
