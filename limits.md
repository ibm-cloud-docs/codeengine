...
| --------------------------- | ------------------------- | ---------------------- |------------------------------------------- |
| CPU                         |                       1.0 |                  12.0 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Ephemeral storage            |                     400 M |  48 G \n  (limited by memory) |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Max scale                   |                        10 |                   250 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Memory                      |                       4 G |                  48 G |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Min scale                   |                         0 |                    250 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Concurrency                 |                       100 |                   1000 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Timeout                     |                300 seconds|            600 seconds |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
...
| Category                     |         Default           |    Maximum value         |     Need to extend the maximum?            |
| ---------------------------- |  ------------------------ | ------------------------ |------------------------------------------- |
| Array indices        |                         0 |                  9999999 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Array size           |                         1 |                     1000 | N/A  |
| CPU                          |                       1.0 |                     12.0 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Ephemeral storage            |                     400 M |  48 G \n  (limited by memory) |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Memory                       |                       4 G |                    48 G |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Retries                      |                         3 |                        5 |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
| Timeout                      |    7200 seconds (2 hours) | 86400 seconds (24 hours) |  [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
{: caption="Job limits"}
...
| ---------------------- |  --------- | ------------------------------------------- |
| Size of data | 4096 bytes | [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
...
| Category  |   Maximum      |       Need to extend the maximum?            |
| ---------------------- |  --------- | ------------------------------------------- |
| Project per region | 20 | [Contact IBM support](/docs/support?topic=support-open-case&interface=ui) |
...
| Subnet pools | You are limited to 1000 subnet pools per project. |
