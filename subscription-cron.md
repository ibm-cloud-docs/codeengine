...
5. Now that your Periodic timer subscription is created, go to the Event subscriptions page to view event information for a job [from the console](docs/codeengine?topic=codeengine-subscribe-cron#view-eventing-cron-job-ui) or [from the CLI](docs/codeengine?topic=codeengine-subscribe-cron#view-eventing-cron-job-cli).
