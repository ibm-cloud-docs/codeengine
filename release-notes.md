...
New region!
:   {{site.data.keyword.codeengineshort}} is supported in a new region: Asia Pacific Chennai, India (`in-che`). See [Regions for {{site.data.keyword.codeengineshort}}](/docs/codeengine?topic=codeengine-regions).
...
### 26 January 2026
{: #codeengine-january2626}
{: release-note}

CLI version 1.60.0 released
:   See [CLI version history](/docs/codeengine?topic=codeengine-cli_versions).
:   **Note**: The `fleet create` command now requires to provide the `--subnetpool-id` or `--subnetpool-name` option to specify the network placement of the fleet workers.
