...
| Date | Description |
| --------- | -------- |
| 17 December 2020 | <ul><li>Updated information for troubleshooting your builds. See [Troubleshooting tips for builds](/docs/codeengine?topic=codeengine-troubleshoot-build).</li><li>CLI version 0.5.8 and 0.5.9 released. See [CLI version history](/docs/codeengine?topic=codeengine-cli_versions).</li></ul> |
...
| Date | Description |
| --------- | -------- |
| 30 October 2020 | <ul><li>CLI version 0.4.2493 released. See [CLI version history](/docs/codeengine?topic=codeengine-cli_versions).</li><li>You can run a {{site.data.keyword.codeengineshort}} job by using Lithops framework. See [Running jobs with Lithops framework](/docs/codeengine?topic=codeengine-lithops).</li></ul> |
